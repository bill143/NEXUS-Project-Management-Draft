...
def export_excel(
    ...
    try:
        wb.properties.creator = "NEXUS · DataDrivenConstruction"
        wb.properties.lastModifiedBy = "NEXUS"
        wb.properties.description = (
            "Generated by NEXUS "
            "(https://nexus.eliteal.info) · DDC-CWICR-OE-2026"
        )
        wb.properties.keywords = "DDC-CWICR-OE,NEXUS,BIM Requirements"

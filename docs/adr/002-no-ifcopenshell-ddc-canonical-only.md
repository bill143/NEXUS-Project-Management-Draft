...
NEXUS has explicitly banned IfcOpenShell since project inception (`CLAUDE.md` line: «НЕ используем IfcOpenShell — весь BIM/CAD через DDC cad2data pipeline»). The reasoning:
